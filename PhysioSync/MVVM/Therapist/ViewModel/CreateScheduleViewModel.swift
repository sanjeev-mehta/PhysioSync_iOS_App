...
class CreateScheduleViewModel {
    ...
    func callAssignExercise(_ vc: UIViewController, with parm: [String: Any], completion: @escaping(Bool) -> ()) {
    ...
    func updateExercise(_ vc: UIViewController, id: String ,with parm: [String: Any], completion: @escaping(Bool) -> ()) {
